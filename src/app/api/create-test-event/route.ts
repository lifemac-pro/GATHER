...
export async function GET() {
  try {
    ...
    console.log('Create Test Event API: Connecting to MongoDB with URL:', env.DATABASE_URL.substring(0, 20) + '...');
    ...
    if (mongoose.connection.readyState !== 1) {
      console.error('Create Test Event API: MongoDB connection not ready, state:', mongoose.connection.readyState);
    ...
    console.log('Create Test Event API: Test event inserted with ID:', result.insertedId);
    ...
    try {
      ...
      console.error('Create Test Event API: Error closing MongoDB connection:', closeError);
    }
  }
}
