...
export default function SurveyResponsesPage({
  ...
  const { data: responses, isLoading: responsesLoading } = trpc.survey.getResponses.useQuery(
    { surveyId },
    {
      enabled: !!surveyId && isSignedIn,
      retry: 1,
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 flex items-center justify-between">
          <h1 className="text-3xl font-bold text-[#072446]">
            {isLoading ? "Loading..." : `${survey?.title || "Survey"} Responses`}
          </h1>
        ...
        {!isLoading && survey && (
          <div className="mb-8 rounded-lg bg-white p-6 shadow-lg">
            <h2 className="mb-4 text-xl font-semibold text-[#072446]">Survey Information</h2>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="text-gray-700">{new Date(survey.createdAt).toLocaleDateString()}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Status</p>
                <p className={`font-medium ${survey.isActive ? 'text-green-600' : 'text-red-600'}`}>
                ...
                >
                  ...
                  <div className="space-y-4">
                    {survey?.questions.map((question, qIndex) => {
                      ...
                      return (
                        <div key={qIndex} className="border-t border-gray-100 pt-3">
