 ...
 */
export function getFieldError(errors: Record<string, string> | undefined, name: string): string | undefined {
  return errors?.[name];
}
 ...
 */
export function hasFieldError(errors: Record<string, string> | undefined, name: string): boolean {
