  ...
  return (
    <Card className="group overflow-hidden rounded-lg border-none bg-white p-0 shadow-lg transition-all duration-300 hover:shadow-xl">
      ...
      <CardHeader className="pb-0 pt-4">
        <CardTitle className="text-xl font-bold text-[#082865]">{title}</CardTitle>
      </CardHeader>
      ...
      <CardContent>
        ...
        {status === "Not Registered" && (
          <div className="mt-3 w-full">
            <button
              className={`w-full rounded-lg px-4 py-2 text-white shadow-md transition-all ${isLoading ? "cursor-not-allowed bg-gray-400" : "bg-[#0055FF] hover:bg-[#004BD9] hover:shadow-lg"}`}
