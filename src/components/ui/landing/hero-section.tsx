...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[80vh] flex-col items-center justify-center bg-primary px-4 py-16 text-center">
      {/* Background Pattern */}
      <div className="absolute inset-0 z-0 opacity-10 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-secondary via-primary to-primary" />
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <SignInButton mode="modal">
          <Button
            className="bg-white text-primary hover:bg-white/90 hover:shadow-lg transition-all duration-200"
            size="lg"
          >
            Sign in to Continue
          </Button>
