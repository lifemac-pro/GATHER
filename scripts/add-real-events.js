...
const realEvents = [
  {
    ...
    description:
      "Learn the latest web development techniques and frameworks in this hands-on workshop.",
  ...
  },
  {
    ...
    description:
      "Connect with local entrepreneurs and business professionals in a relaxed setting.",
  ...
  },
  {
    ...
    description:
      "Join us for a day of giving back to the community by cleaning up local parks and streets.",
  ...
  },
  {
    ...
    description:
      "A beginner-friendly workshop on machine learning concepts and applications.",
  ...
  },
  {
    ...
    description:
      "Enjoy performances from local bands and musicians across multiple genres.",
