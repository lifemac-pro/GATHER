...
const events = [
  ...
  },
  {
    ...
    description:
      "Watch innovative startups pitch their ideas to investors and network with entrepreneurs.",
    date: "April 5, 2025",
  ...
  },
  {
    ...
    description:
      "Explore the intersection of artificial intelligence and blockchain technologies in this cutting-edge summit.",
    date: "May 15, 2025",
  ...
  },
  {
    ...
    description:
      "Enhance your professional skills with workshops on leadership, communication, and career development.",
    date: "May 15, 2025",
  ...
  },
  {
    ...
    description:
      "A program designed to develop leadership skills in young professionals and students.",
    date: "June 24, 2025",
  ...
  },
  {
    ...
    description:
      "A virtual gathering of innovative minds from northern universities.",
    date: "April 18, 2025",
...
/**
 * Creates notifications for a user
  ...
  const notifications = [
    {
      ...
      message:
        "Thank you for joining GatherEase. Start exploring events and connecting with others.",
      type: "EVENT_UPDATE",
      read: false,
    ...
    },
    {
      ...
      message:
        "Your registered event 'Tech Conference 2025' is coming up soon.",
      type: "EVENT_REMINDER",
      read: true,
    ...
    },
    {
      ...
      message:
        "Please complete the feedback survey for 'Youth Leadership Training'.",
...
async function seedDatabase() {
  try {
    ...
    if (existingEventsCount > 0) {
      ...
      const deleteEvents = await askQuestion(
        "Do you want to delete existing events and notifications? (y/n): ",
      );
    ...
    const eventIds = Object.values(eventResult.insertedIds).map((id) =>
      id.toString(),
    );

    // Create and insert notifications for the first user
    if (!userIds.length) {
      console.warn("No user IDs available for creating notifications");
      return;
    }
    // We've already checked that userIds has at least one element
    const userId = userIds[0];
    if (!userId) {
      console.warn("First user ID is undefined");
      return;
    }
    const notifications = createNotificationsForUser(userId, eventIds);
    const notificationResult =
      await notificationsCollection.insertMany(notifications);
    console.log(
      `${notificationResult.insertedCount} notifications were inserted`,
    );
